...
const Values = () => {
  return (
    <SectionWrapper additionalClasses={"bg-base-300/60 text-base-content"}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 xl:flex justify-center p-12 mx-auto">
        <Value icon={<MazeIcon />} title="Radical Transparency" description="We consider deployed working software that solves a business function as the primary measure of progress.  Together we will continually focus on the next most valuable and important thing we can finish." />
        <Value icon={<MazeIcon />} title="Open Retrospection" description="Each week the team hosts an event externally, and internally, called the retrospective.  During this we will review the release notes, review the product increment, discuss openly what we are all learning, and how any of our thinking is shifting based on having had more time and greater opportunity to bring your product online together. " />
