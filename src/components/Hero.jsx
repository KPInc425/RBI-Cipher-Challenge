    ...
    <div className="hero-content text-neutral-content w-full py-16">
      <div className="flex flex-col lg:flex-row w-full gap-8">
        <div className="max-w-md flex flex-col items-center text-center mx-auto lg:items-start lg:text-start justify-center gap-4">
          ...
          <p className="mb-5">Experience the thrill of the chase as we present you with a new cipher to solve each week. Will you be the first to crack it?</p>
          <p className="mb-5">From ancient civilizations to modern-day mysteries, our cipher challenges will transport you on a thrilling journey of discovery and exploration.</p>
          <p className="mb-5">Join the ranks of legendary codebreakers and uncover the secrets that lie within our cryptographic conundrums.</p>
