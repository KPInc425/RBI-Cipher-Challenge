  ...
  return (
    <SectionWrapper>
      <div className="flex flex-col gap-4 text-start scroll-slidein-left px-4">
        <h3><span className="font-bold text-2xl">Engage Your Development Teams with Exciting Coding Challenges!</span></h3>
        <p>        
          <h4 className="font-bold text-2xl inline">Are you passionate</h4> about fostering collaboration and problem-solving
