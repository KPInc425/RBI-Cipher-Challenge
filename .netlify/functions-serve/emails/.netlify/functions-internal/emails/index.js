...
// .netlify/functions-internal/emails/index.js
...
var makeRenderTemplateRequest = (fileFound, parameters) => __awaiter(void 0, void 0, void 0, function* () {
  const renderRequest = {
...
var makeSendEmailRequest = (mailRequest) => __awaiter(void 0, void 0, void 0, function* () {
  return yield new Promise((resolve, reject) => {
...
var handler = (event) => __awaiter(void 0, void 0, void 0, function* () {
  var _a, _b, _c, _d;
  ...
  if (event.httpMethod === "GET") {
    ...
    fs_1.default.readdirSync(emailTemplatesDirectory).forEach((template) => {
      if (fs_1.default.existsSync((0, path_1.join)(emailTemplatesDirectory, template, "index.html")) || fs_1.default.existsSync((0, path_1.join)(emailTemplatesDirectory, template, "index.mjml"))) {
